...
export const User = ({id, email, first_name, last_name, avatar, selectUsers, isSelected}) => (
  <li>
    <div>
    ...
    <img onClick={() => selectUsers(id)}  className="action" src={`${isSelected ? "/assets/minus.svg" : "/assets/plus.svg" }`} alt="Action" />
  </li>
